...
function toEmbedUrl(raw: string): string {
  ...
  if (shortMatch) return `https://www.youtube.com/embed/${shortMatch[1]}?autoplay=1&playsinline=1&rel=0`;
  // youtube.com/live/ID
  const liveMatch = raw.match(/youtube\.com\/live\/([\w-]+)/);
  if (liveMatch) return `https://www.youtube.com/embed/${liveMatch[1]}?autoplay=1&playsinline=1&rel=0`;
  return raw;
}
